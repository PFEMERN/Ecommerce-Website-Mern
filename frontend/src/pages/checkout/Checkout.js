            ...
            <div className="limit-check">
                ...
                <div className="info-check">
                    ...
                    <div className="payment-check">
                        ...
                        <Input variant="flushed" id="name-card" required placeholder="Souhail Bourhjoul"/></div>
                        <div><label for="number-card" className="this-label">Credit card number</label><br />
                        <Input variant="flushed" id="number-card" required placeholder="3333-1111-8888-2222"/></div>
                        <div><label for="expir-mt-card" className="this-label">Exp Month</label><br />
                        <Input variant="flushed" id="expir-mt-card" required placeholder="January"/></div>
                        <div className="exp-ye-cvv-check">
                            <div><label for="exp-year" className="this-label">Exp Year</label>
                            <Input variant="flushed" required placeholder="2023" id="exp-year"/></div>
                            <div><label for="cvv-check" className="this-label">Cvv</label>
                            <Input variant="flushed" required placeholder="512" id="cvv-check"/></div>
                        </div>
                        </div>
